...
parser.add_argument('--path_loadSourceMap', type=str, default='../MultiAgentDataset/Solution_DMap/CroppedMap/Set1/Source')
...
(array([      23,       26,       29, ..., 99999945, 99999950, 99999975]), array([1, 1, 1, ..., 1, 1, 1]))
    ...
    def computeSolution(self, chosen_solver):
        ...
        time.sleep(0.3)
        self.compute_thread(chosen_solver)




    def compute_thread(self,  chosen_solver):
        while True:
            try:
