...
class MonitoringMultiAgentPerformance:
    ...
    def update(self, maxstep, log_result):
        ...
        Args:
            ...
            log_result: a tuple containing the performance data of a case
    ...
    def summary(self, current_epoch):
    ...
    def test_summary(self, summary_writer):
        ...
        exp_HyperPara = "{}_F{}_K{}_P{}".format(self.config.exp_net, self.config.numInputFeatures,self.config.nGraphFilterTaps, self.config.nAttentionHeads)
